...
export default function SeeingNow({ movie }: Props) {
  const { name, url, image, premiered, genres, network } = movie;
  const movieYear = getYearFromString(premiered);
  return (
    <div className="seeing-now-container" style={{ backgroundImage: `url(${image.original})` }}>
